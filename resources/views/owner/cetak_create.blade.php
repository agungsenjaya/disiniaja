...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb text-uppercase small">
    <li class="breadcrumb-item"><a href="{{ route('owner.cetak') }}">Cetak</a></li>
    <li class="breadcrumb-item active" aria-current="page">Create</li>
  </ol>
</nav>
<section class="card">
    <div class="card-body">
    <form method="POST" action="{{ route('owner.cetak_store') }}">
      @csrf
  <div class="mb-3 row">
  <div class="col">
    <label class="form-label">Judul Cetak</label>
...
<option value="24rp">24rp</option>
  ...
  <button type="submit" class="btn btn-primary">Insert Cetak</button>
</form>
    </div>
</section>
@endsection
